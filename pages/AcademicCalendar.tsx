...
const AcademicCalendar: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <div className="mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-[#0f172a]">Unggah & Unduh Berkas</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-12 mb-20">
            ...
            {downloadableFiles.map((file, idx) => (
              <div key={idx} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition flex items-center justify-between group">
                <div className="flex items-center space-x-5">
                  <div className="text-3xl bg-gray-50 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:bg-blue-50 transition-colors">
                    {file.icon}
                  </div>
                  <div>
                ...
                <a 
                  ...
                  className="p-4 bg-gray-50 rounded-2xl text-[#3b82f6] hover:bg-[#3b82f6] hover:text-white transition shadow-sm"
                >
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#0f172a] rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl border-b-8 border-blue-500">
            ...
            <div className="relative z-10 space-y-6">
              <div className="inline-block bg-blue-500 text-[10px] font-black tracking-[0.2em] uppercase px-4 py-1.5 rounded-full mb-2 shadow-lg">
              ...
              <div className="flex flex-col space-y-4 pt-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block w-full bg-[#3b82f6] py-5 rounded-2xl font-black text-center text-lg hover:bg-blue-700 transition shadow-xl transform active:scale-95 border-b-4 border-blue-900"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block w-full bg-white text-[#0f172a] py-5 rounded-2xl font-black text-center text-lg hover:bg-blue-50 transition shadow-xl transform active:scale-95 border-b-4 border-blue-400"
                >
                  UNGGAH USPRAK 25-26
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block w-full bg-blue-600 text-white py-5 rounded-2xl font-black text-center text-lg hover:bg-blue-500 transition shadow-xl transform active:scale-95 border-b-4 border-blue-800"
                >
                  UNGGAH DISPENSASI
                </a>
              </div>
              ...
              <div className="py-6 px-6 border border-white/10 bg-white/5 rounded-3xl text-center">
                 <p className="text-[10px] font-bold text-blue-300 uppercase tracking-widest">Gunakan Akun Belajar.id / Google Sekolah</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mb-20">
        <h3 className="text-3xl font-black text-[#0f172a] mb-8 flex items-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="group bg-white rounded-[2.5rem] overflow-hidden shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="relative h-64 overflow-hidden">
              ...
              />
              <div className="absolute top-4 left-4 bg-[#0f172a] text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                Evaluasi Digital
              </div>
            </div>
            <div className="p-8">
              <h4 className="text-xl font-black text-[#0f172a] mb-2">Ujian Sekolah Berbasis Komputer</h4>
          ...
          <div className="group bg-white rounded-[2.5rem] overflow-hidden shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="relative h-64 overflow-hidden">
              <img 
                ...
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute top-4 left-4 bg-[#3b82f6] text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                Uji Kompetensi
              </div>
            </div>
            <div className="p-8">
              <h4 className="text-xl font-black text-[#0f172a] mb-2">Ujian Lisan Prakerin</h4>
              <p className="text-gray-500 text-sm leading-relaxed font-medium">
      ...
      {/* Security Info */}
      <div className="mt-20 bg-blue-50 p-10 rounded-[3rem] border border-blue-100 flex items-center space-x-8">
        <div className="bg-[#3b82f6] text-white p-5 rounded-3xl shadow-lg flex-shrink-0">
          <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
        </div>
        <div>
          <h4 className="text-xl font-black text-[#0f172a] mb-2">Keamanan Data Terjamin</h4>
