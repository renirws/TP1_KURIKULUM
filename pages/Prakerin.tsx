  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <Link to="/" className="inline-flex items-center text-[#3b82f6] font-bold mb-8 hover:underline group">
          ...
          <div className="bg-white rounded-[2rem] shadow-xl overflow-hidden border border-blue-100">
            <div className="bg-[#0f172a] p-8 md:p-12 text-white">
              <div className="flex items-center space-x-3 mb-4">
                <span className="bg-[#3b82f6] text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Pengumuman Prakerin</span>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2v10a2 2 0 002 2z"></path></svg>
                  13 April - 15 April 2026
                </div>
                <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            ...
            <div className="p-8 md:p-12">
              <div className="grid lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2 space-y-8">
                  <section>
                    <h2 className="text-2xl font-bold text-[#0f172a] mb-6 flex items-center">
                      <svg className="w-6 h-6 mr-3 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                      Slide Jadwal Ujian
                    </h2>
                    ...
                    <div className="relative group rounded-3xl overflow-hidden shadow-2xl bg-gray-900 aspect-[3/2]">
                      ...
                      <button 
                        onClick={prevSlide}
                        className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-[#3b82f6] text-white p-3 rounded-full transition-all opacity-0 group-hover:opacity-100"
                      >
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg>
                      </button>
                      <button 
                        onClick={nextSlide}
                        className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-[#3b82f6] text-white p-3 rounded-full transition-all opacity-0 group-hover:opacity-100"
                      >
                    ...
                    <div className="flex gap-4 mt-6 overflow-x-auto pb-2 scrollbar-hide">
                      {images.map((img, idx) => (
                        <button
                          ...
                          className={`flex-shrink-0 w-24 h-16 rounded-lg overflow-hidden border-2 transition-all ${currentIndex === idx ? 'border-[#3b82f6] scale-105 shadow-lg' : 'border-transparent opacity-50 hover:opacity-100'}`}
                        >
                ...
                <div className="space-y-8">
                  <section className="bg-blue-50 p-8 rounded-[2rem] border border-blue-100 shadow-inner">
                    <h3 className="text-xl font-bold text-[#0f172a] mb-6 flex items-center">
                      <svg className="w-6 h-6 mr-2 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                      Ketentuan Ujian
                    </h3>
                    <ul className="space-y-6">
                      <li className="flex items-start">
                        <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center mr-4 flex-shrink-0">
                          <svg className="w-6 h-6 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </div>
                        <div>
                          <p className="font-bold text-[#0f172a]">Seragam</p>
                          <p className="text-gray-600 text-sm">Baju putih panjang bahan, celana panjang hitam bahan, dasi hitam, sepatu pantofel.</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center mr-4 flex-shrink-0">
                          <svg className="w-6 h-6 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <div>
                          <p className="font-bold text-[#0f172a]">Rambut & Kerapihan</p>
                      ...
                      <li className="flex items-start">
                        ...
                        <div>
                          <p className="font-bold text-[#0f172a]">Laporan</p>
                      ...
                      <li className="flex items-start">
                        <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center mr-4 flex-shrink-0">
                          <svg className="w-6 h-6 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        </div>
                        <div>
                          <p className="font-bold text-[#0f172a]">Presentasi</p>
                          <p className="text-gray-600 text-sm">Membawa softcopy PPT untuk presentasi.</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center mr-4 flex-shrink-0">
                          <svg className="w-6 h-6 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <div>
                          <p className="font-bold text-[#0f172a]">Kehadiran</p>
                  ...
                  <div className="bg-[#0f172a] text-white p-8 rounded-[2rem] shadow-lg">
                    ...
                    <button className="w-full py-3 bg-[#3b82f6] hover:bg-blue-700 rounded-xl font-bold transition-colors">
                      Hubungi Koordinator
                    </button>
                  </div>
                </div>
      ...
      {isZoomed && (
        ...
        >
          <button 
            className="absolute top-6 right-6 text-white hover:text-[#3b82f6] transition-colors z-[110] bg-black/50 p-3 rounded-full"
