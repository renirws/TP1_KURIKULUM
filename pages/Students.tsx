    ...
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      ...
      <div className="mt-20">
        ...
        <div className="bg-white rounded-[3rem] shadow-2xl border border-blue-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-8 md:p-12 text-white">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div>
                ...
                <p className="text-blue-100/80 font-medium">Akses rekapitulasi nilai ujian lisan laporan PKL Tahun Pelajaran 2025/2026.</p>
              </div>
              <a 
                href="https://ais-pre-dyfnmc3vskjtpuoanz5k2l-441986179843.asia-southeast1.run.app"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-blue-700 px-8 py-4 rounded-2xl font-black text-sm tracking-widest uppercase hover:bg-blue-50 transition shadow-xl flex items-center space-x-3 flex-shrink-0"
              >
          ...
          <div className="p-8 md:p-12 bg-blue-50/30">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h5 className="font-bold text-[#0f172a] text-lg">Komponen Penilaian:</h5>
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-600">
                    <svg className="w-5 h-5 mr-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
