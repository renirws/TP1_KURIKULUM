...
const Home: React.FC = () => {
  ...
  return (
    <main>
      {/* Hero Section */}
      <motion.section 
        className="relative h-[550px] md:h-[650px] overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#3b82f6]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-blue-50/80 leading-relaxed max-w-2xl font-medium">
              ...
              <div className="flex flex-wrap gap-4 pt-8">
                <Link to="/kurikulum" className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-2xl font-black transition-all transform hover:scale-105 shadow-[0_20px_40px_rgba(37,99,235,0.3)]">
        ...
        <div className="absolute top-1/4 -right-20 w-96 h-96 bg-blue-500 rounded-full blur-[120px] opacity-20"></div>
        <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-cyan-500 rounded-full blur-[100px] opacity-10"></div>
      </motion.section>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-[#0f172a] text-white p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center text-center border border-white/5">
            ...
            <a href="https://s.id/bimlappkl" target="_blank" rel="noopener noreferrer" className="bg-white text-[#0f172a] p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center text-center border border-gray-100 hover:bg-gray-50 transition-all group">
              <div className="text-xl font-black mb-1 group-hover:scale-110 transition-transform text-[#2563eb]">Bimbingan PKL</div>
      ...
      >
        <div className="container mx-auto px-4">
          <header className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link to="/warta" className="group bg-blue-50 text-[#2563eb] font-black px-6 py-3 rounded-2xl flex items-center hover:bg-[#2563eb] hover:text-white transition-all duration-300">
              Lihat Semua Berita
      ...
      >
        <div className="container mx-auto px-4">
          <header className="text-center mb-16">
            <h2 className="text-4xl font-black text-[#0f172a] mb-4">Akses Cepat <span className="text-[#3b82f6]">Digital</span></h2>
          ...
          <div className="grid md:grid-cols-12 gap-6 auto-rows-[240px]">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="md:col-span-4 bg-white rounded-[3rem] p-10 border border-gray-100 shadow-xl group hover:border-[#3b82f6] transition-all duration-500 flex flex-col"
            >
              <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center text-[#3b82f6] mb-8 group-hover:rotate-6 transition-transform">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
              </div>
              <h3 className="text-2xl font-black text-[#0f172a] mb-4">Bimbingan PKL</h3>
              ...
              <div className="mt-auto flex items-center text-[#3b82f6] font-black text-sm group-hover:translate-x-2 transition-transform">
      ...
      >
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-blue-100 transform hover:-translate-y-2 transition duration-500">
              <div className="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg shadow-blue-500/20">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <header className="relative inline-block">
              <h2 className="text-5xl font-black tracking-tight text-[#0f172a]">Tim Kurikulum</h2>
              <div className="w-32 h-2 bg-blue-500 mt-4 rounded-full"></div>
            </header>
            
            <article className="flex items-start space-x-8 bg-white p-10 rounded-[3rem] shadow-xl border border-blue-100 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-48 h-48 bg-blue-50 rounded-bl-full -mr-24 -mt-24 transition-transform group-hover:scale-110"></div>
              
              <div className="relative z-10 pt-2 w-full">
                <h3 className="text-3xl font-black text-[#0f172a]">Reni Widyastuti, M.Kom</h3>
                <p className="text-blue-600 font-black text-xs uppercase tracking-[0.2em] mt-2 italic">Wakil Kepala Sekolah Bidang Kurikulum</p>
                <div className="mt-10 space-y-4">
                  <div className="flex items-center p-4 bg-blue-50 rounded-2xl w-fit group-hover:bg-[#3b82f6] group-hover:text-white transition-all duration-300">
                  ...
                  <div className="flex items-center p-4 bg-slate-50 rounded-2xl w-fit">
                    <svg className="w-5 h-5 mr-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span className="font-bold text-sm text-[#0f172a]">Senin - Kamis | 06:30 - 14:45</span>
                  </div>
                </div>
              </div>
            </article>
          ...
          <aside className="bg-[#0f172a] text-white p-12 md:p-16 rounded-[4rem] shadow-2xl relative overflow-hidden">
            ...
            <form className="space-y-4 relative z-10">
              ...
              <input type="email" placeholder="Email" className="w-full px-6 py-4 rounded-2xl bg-white/5 border border-white/10 focus:outline-none focus:border-[#3b82f6] focus:bg-white/10 transition placeholder:text-white/20 font-bold" />
              <textarea placeholder="Pesan Anda..." rows={4} className="w-full px-6 py-4 rounded-2xl bg-white/5 border border-white/10 focus:outline-none focus:border-[#3b82f6] focus:bg-white/10 transition placeholder:text-white/20 font-bold"></textarea>
              <button className="w-full bg-[#3b82f6] py-5 rounded-2xl font-black hover:bg-blue-700 transition shadow-[0_20px_40px_rgba(59,130,246,0.2)] text-lg uppercase tracking-widest">Kirim Pesan</button>
            </form>
          </aside>
        </div>
      </motion.section>
...
const AnnouncementCard: React.FC<{ category: string, title: string, date: string, excerpt: string, link?: string, videoUrl?: string, imageUrl?: string }> = ({ category, title, date, excerpt, link, videoUrl, imageUrl }) => {
  ...
  return (
    <article className="bg-white border-t-4 border-[#3b82f6] p-8 shadow-sm hover:shadow-xl transition-all group rounded-b-2xl flex flex-col h-full">
      <div className="flex-grow">
        <span className="text-xs font-black uppercase bg-blue-100 text-[#3b82f6] px-3 py-1 rounded-full">{category}</span>
        <h3 className="text-xl font-bold text-[#0f172a] mt-5 group-hover:text-[#3b82f6] transition cursor-pointer leading-tight">{title}</h3>
        ...
        {imageUrl && (
          <>
            ...
            {isZoomed && (
              ...
              >
                <button 
                  className="absolute top-6 right-6 text-white hover:text-[#3b82f6] transition-colors z-[110]"
      ...
      {link ? (
        link.startsWith('http') ? (
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center text-sm font-bold text-[#0f172a] group-hover:text-[#3b82f6] transition"
          >
            Detail Berita 
        ...
        <button className="flex items-center text-sm font-bold text-[#0f172a] group-hover:text-[#3b82f6] transition">
          Detail Berita 
          <svg className="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
        </button>
      )}
